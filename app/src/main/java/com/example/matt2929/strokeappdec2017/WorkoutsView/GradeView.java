...
public class GradeView extends View {
	...
	protected void onDraw(Canvas canvas) {
		...
		canvas.drawText("Now: " + floatToHundreth(newValue), width / 2 + marginWidth, (height + titleHeight) / 2, textTextPaint);
		canvas.drawText("Last: " + floatToHundreth(oldValue), (((width / 3) * 2) + width) / 2, (height + titleHeight) / 2, textTextPaint);
		super.onDraw(canvas);
	}
